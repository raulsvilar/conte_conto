...
class Conto {
  ...
  Conto.newConto(this.title, this.author, this.owner, {this.teacherID, this.reference,
    this.content, this.isFavorited=false, this.turmaID, this.finished = false, this.creationDate});
