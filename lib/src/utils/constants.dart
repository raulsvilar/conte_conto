...
const DESCRIPTION_TERMS_SERVICE =
    "Ao se cadastrar você aceita nossos termos de serviço";
...
const DESCRIPTION_NO_MATERIALS_IN_CLASS = "Ainda não há materiais aqui!";
...
const DESCRIPTION_STUDENTS_CLASS_CONTOS_PAGE = 'StudentsClassContosPage';
