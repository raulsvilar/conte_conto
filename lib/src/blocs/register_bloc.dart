...
class RegisterBloc extends BlocBase with Validator {
  ...
  final _userTypeController =
      BehaviorSubject<userTypes>.seeded(userTypes.student);
  ...
  Future<User> register(
      String email, String name, String password, int type) async {
  ...
  submit(BuildContext context, Function navigateCallback,
